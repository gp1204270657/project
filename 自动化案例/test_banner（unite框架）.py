...
class Bannner(unittest.TestCase):
    ...
    def test_banner(self):
        ...
        driver.add_cookie(
            {"name": 'Hm_lvt_b80587b2e0c6e8cc2da0183796d6e6e7', 'value': '1520563331, 1522309021, 1522371437'})
        driver.add_cookie({"name": 'Hm_lpvt_0cab8be8d73e44819d9a5782a1ee9fa8', 'value': '1522721748'})
        driver.add_cookie(
            {"name": 'Hm_lvt_0cab8be8d73e44819d9a5782a1ee9fa8', 'value': '1522285569,1522372454,1522631362,1522717574'})
